...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    '''
    Business: Save email to waitlist for launch notification
    ...
    if result:
        return {
            ...
            'body': json.dumps({'success': True, 'message': 'Email added to waitlist'}),
            'isBase64Encoded': False
        }
    else:
        return {
            ...
            'body': json.dumps({'success': True, 'message': 'Email already registered'}),
            'isBase64Encoded': False
        }
