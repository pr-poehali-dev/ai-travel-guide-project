    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <div className="relative w-12 h-12 rounded-full bg-primary flex items-center justify-center">
              <div className="absolute w-10 h-10 rounded-full bg-secondary top-1 left-1"></div>
              <div className="absolute w-3 h-8 bg-secondary rounded-full rotate-45 top-1 right-1"></div>
              <div className="absolute w-3 h-8 bg-secondary rounded-full -rotate-45 top-1 left-1"></div>
            </div>
          </div>
      ...
      <section className="pt-24 pb-16 bg-background relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 pointer-events-none">
          <div className="absolute top-20 right-0 w-96 h-96 rounded-full bg-primary blur-3xl"></div>
          <div className="absolute top-40 right-20 w-72 h-72 rounded-full bg-secondary blur-2xl"></div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div className="space-y-6 animate-fade-in">
              ...
              <Button 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-secondary font-bold rounded-full px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all"
              >
                подробнее
              </Button>
            </div>
            ...
            <div className="relative animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-primary text-secondary px-6 py-3 rounded-full font-bold text-lg shadow-xl flex items-center gap-2">
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-lg p-3 flex items-center gap-2 flex-wrap justify-center">
              <Button 
                variant="ghost" 
                size="icon" 
                className="bg-primary text-secondary rounded-full hover:bg-primary/90 shadow-md"
              >
                <Icon name="Plus" size={20} />
              </Button>
              {["для тебя", "для дома", "для семьи", "для устройств", "для бизнеса", "для карьеры"].map((tab) => (
                <Button
                  ...
                  className={`rounded-full px-6 font-medium transition-all ${
                    activeTab === tab ? 'bg-muted' : 'hover:bg-muted/50'
                  }`}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 cursor-pointer bg-gradient-to-br from-gray-100 to-gray-200 border-0 rounded-3xl">
                <CardContent className="p-8 h-64 flex flex-col justify-between">
                  <div>
                    <Badge className="bg-white text-secondary mb-4 font-bold">подписка</Badge>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex gap-2">
                      ...
                      <div className="w-8 h-8 rounded-full bg-green-600 shadow-md"></div>
                    </div>
                  </div>
                </CardContent>
              </Card>

              <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 cursor-pointer bg-gradient-to-br from-primary via-yellow-400 to-yellow-500 border-0 text-secondary rounded-3xl">
                <CardContent className="p-8 h-64 flex flex-col justify-between">
                  <div>
                    <Badge className="bg-white text-primary mb-4 font-bold">подписка</Badge>
              ...
              <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 cursor-pointer bg-gradient-to-br from-gray-800 to-gray-900 border-0 text-white rounded-3xl">
                <CardContent className="p-8 h-64 flex flex-col justify-between">
                  <div>
                    <Badge className="bg-primary text-secondary mb-4 font-bold">план Б.</Badge>
                    <h3 className="text-2xl font-black mb-2">план Б.</h3>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-baseline gap-2">
                      <span className="text-sm font-medium opacity-75">AI</span>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <Card 
                  key={index} 
                  className="border-2 hover:border-primary transition-all duration-300 hover:shadow-xl animate-fade-in-up rounded-3xl"
      ...
      <section className="py-20 bg-secondary text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full bg-primary blur-3xl"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-secondary font-bold rounded-full px-12 py-6 text-xl shadow-2xl hover:shadow-primary/50 transition-all"
            >
              Подключиться сейчас
            </Button>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li><a href="#" className="hover:text-foreground transition-colors">Личный кабинет</a></li>
                <li><a href="#" className="hover:text-foreground transition-colors">Приложение</a></li>
                <li><a href="#" className="hover:text-foreground transition-colors">Роуминг</a></li>
              </ul>
            </div>
            <div>
